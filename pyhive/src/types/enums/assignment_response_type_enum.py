"""Re-export of :class:`AssignmentResponseTypeEnum` from the auto-generated enum layer.
...
from .._generated.enums import AssignmentResponseTypeEnum

__all__ = ["AssignmentResponseTypeEnum"]
